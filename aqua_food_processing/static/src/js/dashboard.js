...
import { LiquidLens } from "../components/liquid_lens/liquid_lens";

class AquaDashboard extends Component {
    static template = "aqua_food_processing.DashboardMain";
    static components = { KpiTile, ChartWidget, DrillPanel, FilterBar, LiquidLens };
    ...
    setup() {
        ...
        // Now a standalone component - see
        // ../components/liquid_lens/liquid_lens.js for the full
        // explanation and implementation, and the <LiquidLens/> tag near
        // the top of dashboard_templates.xml for where it's mounted. It
        // manages its own refs and mount/unmount lifecycle internally, so
        // nothing is needed here beyond listing it in static components
        // above.
    }
