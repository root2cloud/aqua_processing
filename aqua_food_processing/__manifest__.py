{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'aqua_food_processing/static/src/css/liquid_lens.css',
            'aqua_food_processing/static/src/css/date_picker.css',
            'aqua_food_processing/static/src/components/liquid_lens/liquid_lens.js',
            'aqua_food_processing/static/src/components/liquid_lens/liquid_lens.xml',
            ...
            'aqua_food_processing/static/src/components/date_picker/date_picker.js',
            'aqua_food_processing/static/src/components/date_picker/date_picker.xml',
            'aqua_food_processing/static/src/components/filter_bar/filter_bar.js',
            'aqua_food_processing/static/src/components/filter_bar/filter_bar.xml',
